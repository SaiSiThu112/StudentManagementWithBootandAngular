...
public class UserController {
	...
	/*@GetMapping(value="/user/{userName}/{userPassword}",produces = "application/json")
	public ResponseEntity<Boolean> userLogin(@PathVariable String userName,@PathVariable String userPassword) {
	     boolean condition=userService.getUserNameandPassword(userName, userPassword);
